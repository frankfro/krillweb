...
export class PortfolioComponent implements OnInit {
  ...
  public tracks = [
    new TracksComponentModel('061218/mystery strings with piano.mp3','Mystery Strings',''),
    new TracksComponentModel('061218/pink floyd 6.mp3','Cinematic Guitar no 6',''),
    new TracksComponentModel('061218/bartok slap arpeggio.mp3','Bartok Arpeggio',''),
    new TracksComponentModel('061218/woodwind beat synth(2).mp3','Woodwind Beat synth',''),
    new TracksComponentModel('061218/simple strings 2.mp3','Simple Strings no 1',''),
    new TracksComponentModel('061218/bass slaps with synth.mp3','Bass Slap',''),
    new TracksComponentModel('061218/guitar with strings with marching percussion.mp3','Guitar with Marching Band Strings',''),
    new TracksComponentModel('061218/bottom of the bay techno mix(3).mp3','Bottom of the Bay Techno Mix',''),
    new TracksComponentModel('061218/bottom of the bay.mp3','Bottom of the Bay',''),
    new TracksComponentModel('061218/CF3v3-S1.mp3','Piano Clouds',''),
    ...
    new TracksComponentModel('Park Street.mp3','Piano Theme 2 Park Street ',''),
    ...
    new TracksComponentModel('Journey Trance.mp3','Journey Trance ',''),
    ...
    new TracksComponentModel('ominous 1 with violin.mp3','Ominous 1 with violin ',''),
    new TracksComponentModel('ominous 1.mp3','Ominous 1 ',''),
    new TracksComponentModel('ominous 2 with violin.mp3','Ominous 2 with violin ',''),
    new TracksComponentModel('ominous 2.mp3','Ominous 2 ',''),
    new TracksComponentModel('sample gtr 1.mp3','Sample gtr 1 ',''),
    new TracksComponentModel('short artic choir WITH GUITAR.mp3','Short artic choir WITH GUITAR ',''),
    new TracksComponentModel('short artic choir with lite percussion 2.mp3','Short artic choir with lite percussion 2 ',''),
    new TracksComponentModel('short artic choir.mp3','Short artic choir ',''),
    new TracksComponentModel('short harp ending 2 with extra ending.mp3','Short harp ending 2 with extra ending ',''),
    new TracksComponentModel('short harp ending 2(3).mp3','Short harp ending ',''),
    new TracksComponentModel('slowly building higher strings(2).mp3','Slowly building higher strings ',''),
    new TracksComponentModel('trill strings.mp3','Trill strings ',''),
    new TracksComponentModel('arpeggio 1 with piano and violin.mp3','Arpeggio 1 with piano and violin ',''),
    new TracksComponentModel('arpeggio 1(2).mp3','Arpeggio 1 ',''),
    new TracksComponentModel('cool march.mp3','Cool march ',''),
    new TracksComponentModel('Distant Symphony with Arpeggio.mp3','Distant Symphony with Arpeggio ',''),
    new TracksComponentModel('Distant Symphony with Piano.mp3','Distant Symphony with Piano ',''),
    new TracksComponentModel('Distant Symphony with Violin(2).mp3','Distant Symphony with Violin ',''),
    new TracksComponentModel('Distant Symphony.mp3','Distant Symphony ',''),
    new TracksComponentModel('guitar mars 2.mp3','guitar mars ',''),
    new TracksComponentModel('guitar with trill strings.mp3','guitar with trill strings ',''),
